...
SECRET_KEY = 'django-insecure-$ols)1h1lgh5ze)rjh2z4e6lekjc369quu8b*(f9ui4zg$6ss('
...
if DEBUG:
    # Development: serve static files directly from here
    STATICFILES_DIRS = [
        os.path.join(BASE_DIR, 'static'),  # or 'assets' or another dir
    ]
